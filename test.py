...
class NetworkScanner:
    def __init__(self, subnet='10.9.0.0/24', log_dir='network_logs'):
        ...
        self.__setup_logging_directory()

        # Configure main logging
        self.logger = self.__configure_logger('network_scanner', 'network_scanner.log')

        # Packet-specific logger
        self.packet_logger = self.__configure_logger('packet_capture', 'packet_capture.log')

    def __setup_logging_directory(self):
    ...
    def __configure_logger(self, name, filename, level=logging.INFO):
        """
...
# Ensure the main function is executed only when this script is run directly
